    ...
    MouseArea {
        ...
        QQC2.StackView {
            ...
            initialItem: Login {
                ...
                actionItems: [
                    ActionButton {
                        iconSource: Qt.resolvedUrl("assets/suspend_primary.svg")
                    ...
                    ActionButton {
                        iconSource: Qt.resolvedUrl("assets/restart_primary.svg")
                    ...
                    ActionButton {
                        iconSource: Qt.resolvedUrl("assets/shutdown_primary.svg")
                    ...
                    ActionButton {
                        iconSource: Qt.resolvedUrl("assets/switch_primary.svg")
